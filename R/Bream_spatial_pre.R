...
#' @return a list containing the data used in the main script
#'
...
Bream_spatial_pre<-function(userpath,forcings){
  ...
  currentpath=getwd()
  filepath=paste0(userpath,"/Bream_spatial/Inputs/Forcings_plots//Feeding.jpeg")
