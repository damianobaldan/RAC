...
Bream_ind_pre<-function(userpath,forcings){
...
Food=read.csv(paste0(userpath,"/Bream_individual/Inputs/Forcings//Food_characterization.csv"),sep=",",header=FALSE)    # Reading the food composition (Proteins, Lipids, Carbohydrates) data
