...
excSave=exc[(ti+1):(tf-1),]
wstSave=wst[(ti+1):(tf-1),]
ingSave=ing[ti:(tf-2)]
ingveroSave=ingvero[ti:(tf-2)]
TfunSave=Tfun[(ti+1):(tf-1),]
metabSave=metab[(ti+1):(tf-1),]
O2Save=O2[(ti+1):(tf-1)]
NH4Save=NH4[(ti+1):(tf-1)]
...
# Plot weight
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_plots//weight.jpeg")
...
# plot excretion
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_plots//faeces_production.jpeg")
jpeg(filepath,800,600)
...
# plot wasted food
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_plots//wasted_feed.jpeg")
jpeg(filepath,800,600)
...
# plot ingested food
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_plots//actual_ingestion.jpeg")
jpeg(filepath,800,600)
...
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_plots//temperature_response.jpeg")
jpeg(filepath,800,600)
...
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_plots//metabolism.jpeg")
jpeg(filepath,800,600)
...
# Plot O2 consumed
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_plots//O2_consumption.jpeg")
jpeg(filepath,800,600)
...
# Plot NH4 produced
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_plots//NH4_release.jpeg")
jpeg(filepath,800,600)
plot(days,O2Save,ylab="NH4 release (gN/d)", xlab=" ",xaxt = "n",type="l",cex.lab=1.4)
labDates <- seq(as.Date(Dates[1], format = "%d/%m/%Y"), tail(days, 1), by = "months")
axis.Date(side = 1, days, at = labDates, format = "%d %b %y", las = 2)
dev.off()
...
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//weight.csv")
write.csv(weightSave,filepath)

filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//faeces_production.csv")
write.csv(excSave,filepath)

filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//wasted_feed.csv")
write.csv(wstSave,filepath)

filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//potential_ingestion.csv")
...
filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//temperature_response.csv")
write.csv(TfunSave,filepath)

filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//metabolism.csv")
write.csv(metabSave,filepath)

filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//O2_consumption.csv")
write.csv(O2Save,filepath)

filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//NH4_release.csv")
write.csv(NH4Save,filepath)

filepath=paste0(userpath,"/Bream_individual/Outputs/Out_csv//Days_to_commercial_size.csv")
