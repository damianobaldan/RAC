...
Bass_pop_post<-function(userpath,output,times,Dates,N,CS) {
  ...
  # Plot weight
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//weight.jpeg")
  ...
  # plot excretion
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//faeces_production.jpeg")
  jpeg(filepath,800,600)
  ...
  # plot wasted food
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//wasted_feed.jpeg")
  jpeg(filepath,800,600)
  ...
  # plot ingested food
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//actual_ingestion.jpeg")
  jpeg(filepath,800,600)
  ...
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//temperature_response.jpeg")
  jpeg(filepath,800,600)
  ...
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//metabolism.jpeg")
  jpeg(filepath,800,600)
  Aub=ASave[,1]+ASave[,2]
  Cub=CSave[,1]+CSave[,2]
  ...
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//Population.jpeg")
  jpeg(filepath,800,600)
  ...
  # plot O2 consumption
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//O2_consumption.jpeg")
  jpeg(filepath,800,600)
  ...
  # plot NH4 production
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//NH4_release.jpeg")
  jpeg(filepath,800,600)
  ...
  # Results save
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//weight.csv")
  write.csv(weightSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//faeces_production_Proteins.csv")
  write.csv(PexcSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//faeces_production_Lipids.csv")
  write.csv(LexcSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//faeces_production_Carbohydrates.csv")
  write.csv(CexcSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//wasted_feed_Proteins.csv")
  write.csv(PwstSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//wasted_feed_Lipids.csv")
  write.csv(LwstSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//wasted_feed_Carbohydrates.csv")
  write.csv(CwstSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//actual_ingestion.csv")
  write.csv(ingestionSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//anabolic_rate.csv")
  write.csv(ASave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//catabolic_rate.csv")
  write.csv(CSave,filepath)

  tfun=cbind(fgT,frT)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//temperature_response.csv")
  write.csv(tfun,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//O2_consumption.csv")
  write.csv(O2Save,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//NH4_release.csv")
  write.csv(NH4Save,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//population.csv")
  write.csv(N,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//Days_to_commercial_size.csv")
